export default {
    template: `
        <section>
            ...
            <form id="my-form">
                ...
                <label for="password">Enter tour password:</label>
                <input :model="password" type="password" name="password" required placeholder="password">

                <input @click.prevnet="submitUserData" type="submit" value="Sign Up / Log In">
            </form>
        </section>
    `,
    ...
    methods: {
        submitUserData() {
            ...
            // refer to the Node Mailer example from last semester as to how to get data from a form into
            // a Fetch call using POST
